...
# jorisroovers: don't install pyHS100 from pip, we use our own copy
    ...
    def update(self):
        ...
        try:
            ...
            if self.smartplug.has_emeter:
                ...
                # jorisroovers: patched the following lines to take the new
                # json return structure into account:
                #{'voltage_mv': 222738, 'current_ma': 17, 'power_mw': 0,
                # 'total_wh': 101}
                ...
                # jorisroovers: commented out the following lines because they
                # gave an error and I don't need this functionality
